...
class deCasteljauTestCase(unittest.TestCase):
    ...
    def testSinglePoint(self):
        ...
        beziercurve = bezier_curve_generator(ControlPoints([self.point1]))
    ...
    def testParameterZero(self):
        ...
        beziercurve = bezier_curve_generator(ControlPoints([self.point1, self.point2, self.point3]))
    ...
    def testExaustive(self):
        ...
        beziercurve = bezier_curve_generator(ControlPoints(controlPointsList))
